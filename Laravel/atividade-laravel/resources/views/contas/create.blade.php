            ...
            <form action="{{route('contas.store')}}" method="POST">
                ...
                <div class="form-row justify-content-center">
                    ...
                    <div class="form-group col-sm-8 col-md-10 col-lg-8">
                        ...
                        <input type="text" class="form-control" id="instituicao" name="instituicao" placeholder="Devedor...">
                ...
                <div class="form-row justify-content-center">
                    ...
                    <div class="form-group col-sm-8 col-md-10 col-lg-8">
                        ...
                        <input type="date" class="form-control" id="data_pgto" name="data_pgto" placeholder="Data de Expiração...">
