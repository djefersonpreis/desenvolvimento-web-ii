            ...
            <form action="{{route('contas.store')}}" method="POST">
                ...
                <div class="form-row justify-content-center">
                    <div class="form-group text-left col-sm-8 col-md-10 col-lg-8">
                        ...
                        <input type="text" class="form-control" id="instituicao" name="instituicao" required placeholder="Devedor...">
                    </div>
                </div>
                ...
                <div class="form-row justify-content-center">
                    <div class="form-group text-left col-sm-8 col-md-10 col-lg-8">
                        ...
                        <input type="number" step="0.1" class="form-control" id="preco" name="preco" required placeholder="Preço...">
                    </div>
                </div>
                ...
                <div class="form-row justify-content-center">
                    <div class="form-group text-left col-sm-8 col-md-10 col-lg-8">
                        ...
                        <input type="date" class="form-control" id="data_pgto" name="data_pgto" required placeholder="Data de Expiração...">
                    </div>
                ...
                <div class="form-row justify-content-center">
                    ...
                    <button type="submit" class="btn btn-primary col-sm-6 col-md-5 col-lg-4 py-2 mt-1"> Adicionar </button>
                </div>
