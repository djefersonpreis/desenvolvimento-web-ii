            ...
            <form action="{{route('contas.update', $conta->id)}}" method="POST">
                ...
                <div class="form-row justify-content-center">
                    <div class="form-group text-left col-sm-8 col-md-10 col-lg-8">
                        ...
                        <input type="number" step="0.1" class="form-control" id="preco"
               ...
               <div class="form-row justify-content-center">
                    ...
                    <a href="#modalUpdate" class="btn btn-primary col-sm-6 col-md-5 col-lg-4 py-2 mt-1"
